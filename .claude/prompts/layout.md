...
conventions (style, scope discipline, tooling rules) are already
...
- The dashboard page currently only has placeholder text — replace it with a simple welcome view showing the logged-in user's username, email, and role